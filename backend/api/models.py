...
class UpdateBookmark(models.Model):
    ...
    id = models.AutoField(primary_key=True)
    update = models.ForeignKey(
        Update, on_delete=models.CASCADE, related_name="bookmarks"
    )
    user = models.ForeignKey(
...
class ActivityNew(models.Model):
    ...
    category = models.ForeignKey(
        ActivityCategoryNew, on_delete=models.PROTECT, related_name="activities"
    )
    status = models.ForeignKey(
        ActivityStatusNew, on_delete=models.PROTECT, related_name="activities"
    )
    priority = models.ForeignKey(
        ActivityPriorityNew, on_delete=models.PROTECT, related_name="activities"
    )
    ...
    # Metadata
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="created_activities_new"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    is_active = models.BooleanField(default=True)
...
class NewsUpdateNew(models.Model):
    ...
    # Relationships (simplified)
    category = models.ForeignKey(
        NewsCategoryNew, on_delete=models.PROTECT, related_name="updates"
    )
    status = models.ForeignKey(
        NewsStatusNew, on_delete=models.PROTECT, related_name="updates"
    )
    ...
    # Metadata
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="created_updates_new"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    is_active = models.BooleanField(default=True)

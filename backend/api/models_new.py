...
class Activity(models.Model):
    ...
    status = models.ForeignKey(ActivityStatus, on_delete=models.PROTECT, related_name='activities')
    priority = models.ForeignKey(ActivityPriority, on_delete=models.PROTECT, related_name='activities')
...
class NewsUpdate(models.Model):
    ...
    # Relationships (simplified)
    category = models.ForeignKey(NewsCategory, on_delete=models.PROTECT, related_name='updates')
    status = models.ForeignKey(NewsStatus, on_delete=models.PROTECT, related_name='updates')

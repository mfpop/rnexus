...
class ActivityViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):  # type: ignore[override]
        # Build queryset at runtime to keep static analyzers happy and allow per-user scoping later
    ...
    def update(self, request, *args, **kwargs):
        # Support ISO fields from the frontend (start_time/end_time naming)

#!/usr/bin/env python3
"""
Script to populate the database with location data for USA and Mexico.
This includes countries, states, cities, and zip codes.
"""
...
def create_countries():
    ...
    countries_data = [
        ...
        {"code": "ARG", "name": "Argentina", "flag_emoji": "🇦🇷", "phone_code": "+54"},
        {"code": "CHL", "name": "Chile", "flag_emoji": "🇨🇱", "phone_code": "+56"},
        {"code": "COL", "name": "Colombia", "flag_emoji": "🇨🇴", "phone_code": "+57"},
        {"code": "PER", "name": "Peru", "flag_emoji": "🇵🇪", "phone_code": "+51"},
        {"code": "VEN", "name": "Venezuela", "flag_emoji": "🇻🇪", "phone_code": "+58"},
        {"code": "URY", "name": "Uruguay", "flag_emoji": "🇺🇾", "phone_code": "+598"},
        {"code": "PRY", "name": "Paraguay", "flag_emoji": "🇵🇾", "phone_code": "+595"},
        {"code": "BOL", "name": "Bolivia", "flag_emoji": "🇧🇴", "phone_code": "+591"},
        {"code": "ECU", "name": "Ecuador", "flag_emoji": "🇪🇨", "phone_code": "+593"},
        {"code": "GUY", "name": "Guyana", "flag_emoji": "🇬🇾", "phone_code": "+592"},
        {"code": "SUR", "name": "Suriname", "flag_emoji": "🇸🇷", "phone_code": "+597"},
    ]
...
def create_usa_states():
    ...
    for state_data in us_states:
        state, created = State.objects.get_or_create(
            name=state_data["name"], country=usa, defaults={"code": state_data["code"]}
        )
        if created:
...
def create_usa_cities_and_zipcodes():
    ...
    for city_data in ca_cities:
        ...
        for zip_code in city_data["zip_codes"]:
            ...
            if created:
                print(f"  Created zip code: {zip_code}")
    ...
    ny_cities = [
        ...
        {"name": "Buffalo", "zip_codes": ["14201", "14202", "14203", "14204", "14205"]},
        {
            "name": "Rochester",
    ...
    tx_cities = [
        {"name": "Houston", "zip_codes": ["77001", "77002", "77003", "77004", "77005"]},
        {"name": "Dallas", "zip_codes": ["75201", "75202", "75203", "75204", "75205"]},
        {"name": "Austin", "zip_codes": ["73301", "73344", "78701", "78702", "78703"]},
    ]
...
def create_mexico_cities_and_zipcodes():
    ...
    jal_cities = [
        ...
        {"name": "Zapopan", "zip_codes": ["45010", "45020", "45030", "45040", "45050"]},
        {
            "name": "Tlaquepaque",
...
def main():
    ...
    try:
        # Create countries
        usa, mexico = create_countries()

        # Create states
        create_usa_states()
        create_mexico_states()

        # Create cities and zip codes
        create_usa_cities_and_zipcodes()
        create_mexico_cities_and_zipcodes()

...
export class ChatApiService {
  ...
  static async getMessages(
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/chat/${chatId}/messages/?page=${page}&page_size=${pageSize}`,
        {
          method: "GET",
          headers: AuthService.getAuthHeaders(),
          credentials: "include",
  ...
  static async updateMessageStatus(
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/message/${messageId}/status/`,
        {
          method: "PUT",
          headers: AuthService.getAuthHeaders(),
          credentials: "include",
  ...
  static async searchMessages(
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/chat/search/?chat_id=${chatId}&q=${encodeURIComponent(query)}`,
        {
          method: "GET",
          headers: AuthService.getAuthHeaders(),
          credentials: "include",

...
const loadTeamsSDK = async () => {
  ...
  try {
    ...
    console.log('TeamsService: Microsoft Teams SDK not available - running in standalone mode');
    return null;
  }
};
...
class TeamsService {
  ...
  async initialize(): Promise<boolean> {
    try {
      ...
      try {
        console.log('TeamsService: Attempting to initialize Microsoft Teams...');
        await teamsSDK.initialize();

        // Get the current context
        try {
          this.teamsContext = await teamsSDK.getContext();
          console.log('TeamsService: Microsoft Teams initialized successfully with context');
        } catch (contextError) {
          console.log('TeamsService: Could not get Teams context, but SDK initialized:', contextError instanceof Error ? contextError.message : String(contextError));
        ...
        console.log('TeamsService: Not in Teams environment - running in standalone mode:', teamsError instanceof Error ? teamsError.message : String(teamsError));
        this.isInitialized = true;
        return true;
      }
    } catch (error) {
      ...
      const mockMeetings: TeamsMeeting[] = [
        {
          ...
          status: 'scheduled',
          joinUrl: 'https://teams.microsoft.com/l/meetup-join/19:meeting_123456789@thread.v2/0?context={"Tid":"12345678-1234-1234-1234-123456789012","Oid":"87654321-4321-4321-4321-210987654321"}',
          meetingId: '123456789'
        },
        {
          id: '2',
          ...
          status: 'scheduled',
          joinUrl: 'https://teams.microsoft.com/l/meetup-join/19:meeting_987654321@thread.v2/0?context={"Tid":"12345678-1234-1234-1234-123456789012","Oid":"87654321-4321-4321-4321-210987654321"}',
          meetingId: '987654321'
        },
        {
          id: '3',
          ...
          status: 'completed',
          joinUrl: 'https://teams.microsoft.com/l/meetup-join/19:meeting_456789123@thread.v2/0?context={"Tid":"12345678-1234-1234-1234-123456789012","Oid":"87654321-4321-4321-4321-210987654321"}',
          meetingId: '456789123'
        }
      ];

      console.log('TeamsService: Returning mock meetings:', mockMeetings.length);
      return mockMeetings;
    } catch (error) {
  ...
  async getChannels(): Promise<TeamsChannel[]> {
    try {
      ...
      console.log('TeamsService: Returning mock channels:', mockChannels.length);
      return mockChannels;
    } catch (error) {
      ...
      if (meetingUrl) {
        ...
        if (this.isTeamsEnvironment()) {
          ...
          try {
            ...
            console.error('TeamsService: Invalid URL format:', meetingUrl, urlError);
            return false;
          }
        }
      }
  ...
  async createMeeting(title: string, startTime: string, endTime: string, participants: string[]): Promise<TeamsMeeting | null> {
    try {
      if (!this.isInitialized) {
        await this.initialize();
      }
  ...
  isTeamsEnvironment(): boolean {
    const result = this.isInitialized && this.teamsContext !== null && microsoftTeams !== null;

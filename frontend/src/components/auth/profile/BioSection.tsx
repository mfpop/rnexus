...
import { FileText, Globe, Linkedin, Twitter, Github, Facebook, Instagram } from "lucide-react";
          ...
          <textarea
            ...
            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) =>
              handleFieldChange("bio", e.target.value)
                ...
                className="w-full h-full min-h-[300px] border-0 border-b-2 border-gray-300 rounded-none px-0 py-3 text-base focus:outline-none focus:border-b-transparent focus:ring-0 bg-transparent transition-colors hover:border-gray-400 resize-none"
            placeholder="Tell us your story, experiences, and what makes you unique..."
          />
          <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-purple-500 to-purple-600 transform scale-x-0 group-focus-within:scale-x-100 transition-transform origin-left"></div>
        </div>
        {errors["bio"] && (
          ...
          <div className="group">
            <div className="relative">
              ...
              <input
                ...
                className="w-full border-0 border-b-2 border-gray-300 rounded-none pl-6 pr-0 py-3 h-12 text-base focus:outline-none focus:border-b-transparent focus:ring-0 bg-transparent transition-colors hover:border-gray-400"

      ...
      <div className="group flex-1 flex flex-col min-h-[400px] mb-6">
        <div className="relative flex-1 min-h-0">
          <textarea
            ...
            className="w-full h-full min-h-[300px] border-0 border-b-2 border-gray-300 rounded-none px-0 py-3 text-base focus:outline-none focus:border-transparent focus:ring-0 bg-transparent transition-colors hover:border-gray-400 resize-none"
          ...
          <div className="group">
            <div className="relative">
              ...
              <input
                ...
                className="w-full border-0 border-b-2 border-gray-300 rounded-none pl-6 pr-0 py-3 h-12 text-base focus:outline-none focus:border-transparent focus:ring-0 bg-transparent transition-colors hover:border-gray-400"

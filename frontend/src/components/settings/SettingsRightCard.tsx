...
const UserRolesEditor: React.FC = () => {
  const [roles, setRoles] = useState<
    Array<{ id: number; name: string; permissions: string[] }>
  >([
      ...
      <div className="grid gap-2">
        {roles.map((r) => (
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <button className="text-xs px-2 py-1 border rounded bg-white text-gray-700">
                Edit
              </button>
              <button
                className="text-xs px-2 py-1 border rounded bg-red-50 text-red-700"
      ...
      database: (
        <div className="space-y-6">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Manage tables, dropdown data and user roles (admin/staff)
            </p>
          </div>
              ...
              <div className="p-4 border rounded-lg">
                <div className="flex items-center justify-between mb-3">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Data shown in dropdown menus across the app
                    </p>
                  </div>
                  <div className="flex items-center gap-2">
                    <button className="text-sm px-3 py-1 border rounded bg-blue-50 text-blue-700">
                      View
                    </button>
                    <button className="text-sm px-3 py-1 border rounded bg-emerald-50 text-emerald-700">
                      Manage
                    </button>
                  </div>
                </div>
                <div className="text-xs text-gray-600">
                  Example entries: Priority (High, Medium, Low), Status (Open,
                  Closed)
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Admins and staff can add or modify data used in dropdown menus.
            </p>
            ...
            {user?.is_staff || user?.is_superuser ? (
              ...
              <div className="text-sm text-gray-600">
                You do not have permissions to manage dropdown data.
              </div>
            )}
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Configure roles and default permissions for users.
            </p>
            {user?.is_staff || user?.is_superuser ? (
              <UserRolesEditor />
            ) : (
              <div className="text-sm text-gray-600">
                You do not have permissions to manage roles.
              </div>
            )}
          </div>
        </div>

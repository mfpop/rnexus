    ...
    const helpContent: Record<string, React.JSX.Element> = {
      ...
      "getting-started": (
        ...
        >
          ...
          {(!selectedSubsection || selectedSubsection === "getting-started") && (
            <>
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-medium">
                  Choose a topic from the left menu to begin exploring Nexus LMD. Each section contains comprehensive guides, tips, and best practices to help you master the platform.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border border-gray-200/60 p-8 hover:shadow-xl transition-all duration-300 hover:scale-105 shadow-lg">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-gray-800 tracking-tight">Welcome Guide</h3>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Discover Nexus LMD's core capabilities and understand how this powerful platform can transform your production management.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border border-gray-200/60 p-8 hover:shadow-xl transition-all duration-300 hover:scale-105 shadow-lg">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-gray-800 tracking-tight">First Login</h3>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Step-by-step guide for your first login experience, ensuring a smooth onboarding process.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border border-gray-200/60 p-8 hover:shadow-xl transition-all duration-300 hover:scale-105 shadow-lg">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-gray-800 tracking-tight">Navigation Basics</h3>
                  </div>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Master the intuitive three-column layout and learn how to navigate efficiently through the interface.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border border-gray-200/60 p-8 hover:shadow-xl transition-all duration-300 hover:scale-105 shadow-lg">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-gray-800 tracking-tight">Dashboard Overview</h3>
                  </div>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Understand key performance indicators, track activities, and monitor metrics that matter most to your organization.
                  </p>
                </div>
              </div>
            </>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gray-50 rounded-xl border border-gray-200 p-8">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="text-gray-600 font-serif font-medium">Chapter 1</span>
                  <div className="w-12 h-1 bg-gray-300 rounded-full"></div>
                </div>
        ...
        >
          ...
          >
            ...
            <motion.p
              ...
              variants={textVariants}
            >
              Comprehensive manufacturing activity management and tracking system
            </motion.p>
          </motion.div>
          ...
          >
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border border-gray-200/60 p-6 shadow-lg">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Activity Management Dashboard Overview</h3>
              ...
              <p className="text-sm text-gray-600 mt-3 text-center">
                The main dashboard provides an overview of all activities with real-time status updates and quick access to key functions.
              </p>
            </div>
          </motion.div>

          {/* Default Activity Management Overview */}
          {(selectedSection === "activities" && (!selectedSubsection || selectedSubsection === "activity-overview")) && (
            <motion.div
            ...
            >
              ...
              <motion.p
                ...
                variants={textVariants}
              >
                The Activity Management system provides comprehensive tools for managing manufacturing activities, tracking progress, and optimizing workflows across your organization.
              </motion.p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                  <h4 className="text-lg font-bold text-blue-800 mb-4 tracking-tight">Key Features</h4>
                  <ul className="text-base text-blue-700 space-y-3">
                    ...
                    >
                      ...
                      <span><strong>Activity Dashboard:</strong> Real-time view of all ongoing activities</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                      <span><strong>Progress Tracking:</strong> Monitor completion status and milestones</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                      <span><strong>Resource Management:</strong> Track equipment and personnel assignments</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                      <span><strong>Time Management:</strong> Estimated vs. actual duration tracking</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                      <span><strong>Quality Control:</strong> Built-in quality and safety checks</span>
                    </motion.li>
                  </ul>
                </motion.div>
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.02, transition: { duration: 0.2 } }}
                >
                  <h4 className="text-lg font-bold text-green-800 mb-4 tracking-tight">Quick Start</h4>
                  <ol className="text-base text-green-700 space-y-3">
                    ...
                    >
                      ...
                      <span>Navigate to the Activities page from the main menu</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    ...
                    >
                      ...
                      <span>Click on any activity to see detailed information</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      ...
                      <span>Use filters and sorting to find specific activities</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      ...
                      <span>Monitor progress and update status as needed</span>
                    </motion.li>
                  </ol>
                </motion.div>
              </div>
          ...
          {selectedSubsection === "activity-list" && (
            ...
            >
              ...
              <motion.p
                ...
                variants={textVariants}
              >
                The left panel displays a comprehensive list of all activities with essential information at a glance.
              </motion.p>
              ...
              >
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200/60 p-4">
                  <h4 className="text-md font-semibold text-gray-800 mb-3 text-center">Activity List Panel</h4>
                  <div className="relative">
                    <iframe
                  ...
                  <p className="text-xs text-gray-600 mt-2 text-center">
                    The activity list shows search functionality, time-based filtering tabs, and individual activity cards with status indicators.
                  </p>
                </div>
              </motion.div>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <ul className="text-base text-blue-700 space-y-3">
                    ...
                    >
                      <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                      <span><strong>Search Bar:</strong> Find activities by title or assigned person</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                      <span><strong>Time Tabs:</strong> Filter by All, Today, Upcoming, or Overdue activities</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                      <span><strong>Activity Cards:</strong> Each activity shows title, type, status, and assignee</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                      <span><strong>Selection:</strong> Click any activity to view detailed information</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                      <span><strong>Visual Indicators:</strong> Color-coded types and status badges</span>
                    </motion.li>
                  </ul>
                </motion.div>
                ...
                >
                  ...
                  <ul className="text-base text-green-700 space-y-3">
                    ...
                    >
                      ...
                      <span>Use the search function to quickly locate specific activities</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      <span className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></span>
                      <span>Switch between time tabs to focus on relevant activities</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      <span className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></span>
                      <span>Look for color-coded activity types for quick identification</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      <span className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></span>
                      <span>Check status badges to understand current progress</span>
                    </motion.li>
                    <motion.li
                      className="flex items-start gap-3"
                      variants={itemVariants}
                    >
                      <span className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></span>
                      <span>Hover over activities to see additional details</span>
                    </motion.li>
                  </ul>
                </motion.div>
              </div>
          ...
          {selectedSubsection === "activity-details" && (
            ...
            >
              ...
              <motion.p
                ...
                variants={textVariants}
              >
                The right panel provides comprehensive information about the selected activity, including progress tracking and management tools.
              </motion.p>
              ...
              >
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200/60 p-4">
                  <h4 className="text-md font-semibold text-gray-800 mb-3 text-center">Activity Details Panel</h4>
                  <div className="relative">
                    <iframe
                  ...
                  <p className="text-xs text-gray-600 mt-2 text-center">
                    The details panel shows activity information, progress tracking, action buttons, and management tools.
                  </p>
                </div>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  >
                    ...
                    <ul className="text-base text-purple-700 space-y-3">
                      ...
                      >
                        ...
                        <span><strong>Description:</strong> Detailed activity description</span>
                      </motion.li>
                      <motion.li
                        className="flex items-start gap-3"
                        variants={itemVariants}
                      >
                        <span className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></span>
                        <span><strong>Progress Bar:</strong> Visual completion indicator</span>
                      </motion.li>
                      <motion.li
                        className="flex items-start gap-3"
                        variants={itemVariants}
                      >
                        <span className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></span>
                        <span><strong>Tags:</strong> Type, status, and priority badges</span>
                      </motion.li>
                    </ul>
                  </motion.div>
                  ...
                  >
                    ...
                    <ul className="text-base text-orange-700 space-y-3">
                      ...
                      >
                        ...
                        <span><strong>Timing:</strong> Start, due, and duration information</span>
                      </motion.li>
                      <motion.li
                        className="flex items-start gap-3"
                        variants={itemVariants}
                      >
                        <span className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></span>
                        <span><strong>Assignment:</strong> Who is responsible and when scheduled</span>
                      </motion.li>
                      <motion.li
                        className="flex items-start gap-3"
                        variants={itemVariants}
                      >
                        <span className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></span>
                        <span><strong>Status:</strong> Current activity state</span>
                      </motion.li>
                      <motion.li
                        className="flex items-start gap-3"
                        variants={itemVariants}
                      >
                        <span className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></span>
                        <span><strong>Priority:</strong> Importance level</span>
                      </motion.li>
                    </ul>
                  </motion.div>
                </div>
                ...
                <div className="space-y-4">
                  <motion.div
                    ...
                    whileHover={{ scale: 1.01, transition: { duration: 0.2 } }}
                  >
                    <h4 className="font-semibold text-teal-800 mb-2">Action Buttons</h4>
                    <ul className="text-sm text-gray-600 space-y-1">
                      <li>• <strong>Start:</strong> Begin activity execution</li>
                      <li>• <strong>Pause:</strong> Temporarily halt progress</li>
                      <li>• <strong>Complete:</strong> Mark activity as finished</li>
                      <li>• <strong>Export:</strong> Download activity data</li>
                    </ul>
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    whileHover={{ scale: 1.01, transition: { duration: 0.2 } }}
                  >
                    <h4 className="font-semibold text-indigo-800 mb-2">Information Tabs</h4>
                    <ul className="text-sm text-gray-600 space-y-1">
                      <li>• <strong>Participants:</strong> Team members involved</li>
                      <li>• <strong>Tasks & Milestones:</strong> Breakdown of work</li>
                      <li>• <strong>Equipment:</strong> Required resources</li>
                      <li>• <strong>Notes & Files:</strong> Documentation and attachments</li>
                    </ul>
                  </motion.div>
                </div>
              </div>
          ...
          {selectedSubsection === "filtering-sorting" && (
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Filtering & Sorting Activities</h3>
              <p className="text-gray-600 mb-6">
                Use advanced filtering and sorting options to quickly find and organize activities based on your needs.
              </p>

              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-4">
                  <h4 className="font-semibold text-blue-800 mb-3">Filter Options</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-blue-50 p-3 rounded-lg">
                      <h5 className="font-medium text-blue-800 mb-2">Type Filter</h5>
                    ...
                    <div className="bg-blue-50 p-3 rounded-lg">
                      <h5 className="font-medium text-blue-800 mb-2">Status Filter</h5>
                      <ul className="text-xs text-blue-700 space-y-1">
                ...
                <div className="border-l-4 border-green-500 pl-4">
                  <h4 className="font-semibold text-green-800 mb-3">Sorting Options</h4>
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li>• <strong>Start Time:</strong> Sort by when activities begin</li>
                    <li>• <strong>Title:</strong> Alphabetical order by activity name</li>
                    <li>• <strong>Status:</strong> Group by current state</li>
                    <li>• <strong>Priority:</strong> Order by importance level</li>
                    <li>• <strong>Assigned To:</strong> Sort by responsible person</li>
                  </ul>
                </div>

                <div className="border-l-4 border-purple-500 pl-4">
                  <h4 className="font-semibold text-purple-800 mb-3">Using Filters</h4>
                  <ol className="text-sm text-gray-600 space-y-2">
                    <li>1. Click the "Filter" button to open the filter dropdown</li>
                    <li>2. Select activity type, status, or priority from the dropdowns</li>
                    <li>3. Use the "Sort" button to change the order of activities</li>
          ...
          {selectedSubsection === "creating-activities" && (
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Creating New Activities</h3>
              <p className="text-gray-600 mb-6">
                Learn how to create new activities with proper categorization and detailed information.
              </p>

              {/* Creating Activities Screenshot */}
              <div className="mb-6">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200/60 p-4">
                  <h4 className="text-md font-semibold text-gray-800 mb-3 text-center">Activity Creation Form</h4>
                  <div className="relative">
                    <iframe
                  ...
                  <p className="text-xs text-gray-600 mt-2 text-center">
                    The creation form includes all necessary fields to set up a new activity with proper categorization and planning.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-green-500 pl-4">
                  <h4 className="font-semibold text-green-800 mb-3">Activity Creation Process</h4>
                  <ol className="text-sm text-gray-600 space-y-2">
                    <li>1. <strong>Define Activity:</strong> Provide clear title and description</li>
                    <li>2. <strong>Set Type:</strong> Choose appropriate manufacturing category</li>
                    <li>3. <strong>Assign Priority:</strong> Determine importance level</li>
                    <li>4. <strong>Schedule Timing:</strong> Set start and end dates</li>
                    <li>5. <strong>Assign Resources:</strong> Select personnel and equipment</li>
                    <li>6. <strong>Add Details:</strong> Include notes and attachments</li>
                  </ol>
                </div>
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li>• <strong>Title:</strong> Clear, descriptive activity name</li>
                    <li>• <strong>Description:</strong> Detailed explanation of the work</li>
                    <li>• <strong>Type:</strong> Manufacturing activity category</li>
                    <li>• <strong>Priority:</strong> Importance level (Low, Medium, High, Urgent)</li>
                    <li>• <strong>Timeline:</strong> Start and end dates with duration estimates</li>
                    <li>• <strong>Assignment:</strong> Responsible person and location</li>
                  </ul>
                </div>

                <div className="border-l-4 border-orange-500 pl-4">
                  <h4 className="font-semibold text-orange-800 mb-3">Best Practices</h4>
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li>• Use consistent naming conventions for similar activities</li>
                    <li>• Provide detailed descriptions to avoid confusion</li>
                    <li>• Set realistic time estimates based on historical data</li>
                    <li>• Assign appropriate priority levels for resource planning</li>
                    <li>• Include relevant equipment and material requirements</li>
                    <li>• Add notes for special instructions or safety considerations</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          {selectedSubsection === "managing-activities" && (
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Managing Existing Activities</h3>
              <p className="text-gray-600 mb-6">
                Learn how to effectively manage and update activities throughout their lifecycle.
              </p>

              {/* Managing Activities Screenshot */}
              <div className="mb-6">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200/60 p-4">
                  <h4 className="text-md font-semibold text-gray-800 mb-3 text-center">Activity Management Interface</h4>
                  <div className="relative">
                    <div className="w-full h-40 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border-2 border-dashed border-blue-300 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-blue-600 font-medium text-sm">Activity Management</p>
                        <p className="text-blue-500 text-xs mt-1">Status updates, progress tracking, and resource management</p>
                      </div>
                    </div>
                    <div className="absolute top-2 right-2 bg-blue-600 text-white text-xs px-2 py-1 rounded-full">
                      Screenshot
                  ...
                  <p className="text-xs text-gray-600 mt-2 text-center">
                    The management interface provides tools for updating status, tracking progress, and managing resources throughout the activity lifecycle.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-4">
                  <h4 className="font-semibold text-blue-800 mb-3">Status Management</h4>
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li>• <strong>Planned:</strong> Activity is scheduled but not started</li>
                    <li>• <strong>In Progress:</strong> Work has begun and is ongoing</li>
                    <li>• <strong>Completed:</strong> Activity has been finished successfully</li>
                    <li>• <strong>Cancelled:</strong> Activity was terminated</li>
                    <li>• <strong>Overdue:</strong> Activity missed its deadline</li>
                  </ul>
                </div>

                <div className="border-l-4 border-green-500 pl-4">
                  <h4 className="font-semibold text-green-800 mb-3">Progress Tracking</h4>
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li>• <strong>Update Progress:</strong> Regularly update completion percentage</li>
                    <li>• <strong>Time Tracking:</strong> Record actual time spent vs. estimates</li>
                    <li>• <strong>Milestone Updates:</strong> Mark key milestones as completed</li>
                    <li>• <strong>Issue Logging:</strong> Document problems and resolutions</li>
                    <li>• <strong>Resource Adjustments:</strong> Modify assignments as needed</li>
                  </ul>
                </div>
                ...
                <div className="border-l-4 border-purple-500 pl-4">
                  ...
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li>• <strong>Notes:</strong> Add updates and progress comments</li>
                    <li>• <strong>Attachments:</strong> Include relevant documents and photos</li>
                    <li>• <strong>Notifications:</strong> Alert stakeholders of important changes</li>
                    <li>• <strong>Collaboration:</strong> Work with team members on shared activities</li>
                    <li>• <strong>Reporting:</strong> Generate status reports for management</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          {selectedSubsection === "activity-types" && (
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Manufacturing Activity Types</h3>
              <p className="text-gray-600 mb-6">
                Understanding the different categories of manufacturing activities and their specific requirements.
              </p>

              {/* Activity Types Screenshot */}
              <div className="mb-6">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200/60 p-4">
                  <h4 className="text-md font-semibold text-gray-800 mb-3 text-center">Activity Type Categories</h4>
                  <div className="relative">
                    <div className="w-full h-40 bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg border-2 border-dashed border-indigo-300 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-indigo-600 font-medium text-sm">Activity Categories</p>
                        <p className="text-indigo-500 text-xs mt-1">Color-coded activity types and their descriptions</p>
                      </div>
                    </div>
                  ...
                  <p className="text-xs text-gray-600 mt-2 text-center">
                    Each activity type has specific requirements, workflows, and resource needs based on the manufacturing category.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-blue-700 mb-2">Core manufacturing operations</p>
                  ...
                  <div className="bg-orange-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-orange-700 mb-2">Equipment and facility upkeep</p>
                  ...
                  <div className="bg-yellow-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-yellow-800 mb-2">Inspection & Audit</h4>
                    <p className="text-sm text-yellow-700 mb-2">Quality and compliance checks</p>
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-purple-700 mb-2">Process and system improvements</p>
                ...
                <div className="space-y-4">
                  <div className="bg-indigo-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-indigo-800 mb-2">Logistics</h4>
                    <p className="text-sm text-indigo-700 mb-2">Material and resource flow</p>
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-green-800 mb-2">Quality</h4>
                    <p className="text-sm text-green-700 mb-2">Quality management processes</p>
                  ...
                  <div className="bg-teal-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-teal-800 mb-2">Meetings</h4>
                    <p className="text-sm text-teal-700 mb-2">Team coordination and planning</p>
                  ...
                  <div className="bg-pink-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-pink-800 mb-2">Training</h4>
                    <p className="text-sm text-pink-700 mb-2">Skill development and certification</p>
          ...
          {selectedSubsection === "best-practices" && (
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Activity Management Best Practices</h3>
              <p className="text-gray-600 mb-6">
                Proven strategies for effective activity management and optimal productivity.
              </p>

              {/* Best Practices Screenshot */}
              <div className="mb-6">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200/60 p-4">
                  <h4 className="text-md font-semibold text-gray-800 mb-3 text-center">Best Practices Dashboard</h4>
                  <div className="relative">
                    <div className="w-full h-40 bg-gradient-to-br from-rose-50 to-rose-100 rounded-lg border-2 border-dashed border-rose-300 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-rose-600 font-medium text-sm">Best Practices Guide</p>
                        <p className="text-rose-500 text-xs mt-1">Tips, strategies, and proven methods for success</p>
                      </div>
                    </div>
                  ...
                  <p className="text-xs text-gray-600 mt-2 text-center">
                    Follow these proven strategies to optimize your activity management workflow and improve team productivity.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-green-500 pl-4">
                  <h4 className="font-semibold text-green-800 mb-3">Planning & Organization</h4>
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li>• <strong>Break Down Work:</strong> Divide large activities into manageable tasks</li>
                    <li>• <strong>Set Realistic Deadlines:</strong> Use historical data for accurate estimates</li>
                    <li>• <strong>Prioritize Effectively:</strong> Focus on high-impact activities first</li>
                    <li>• <strong>Resource Planning:</strong> Ensure adequate personnel and equipment</li>
                    <li>• <strong>Risk Assessment:</strong> Identify potential issues early</li>
                  </ul>
                </div>

                <div className="border-l-4 border-blue-500 pl-4">
                  <h4 className="font-semibold text-blue-800 mb-3">Execution & Monitoring</h4>
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li>• <strong>Regular Updates:</strong> Keep progress information current</li>
                    <li>• <strong>Issue Tracking:</strong> Document and resolve problems promptly</li>
                    <li>• <strong>Communication:</strong> Keep stakeholders informed of progress</li>
                    <li>• <strong>Quality Checks:</strong> Maintain standards throughout execution</li>
                    <li>• <strong>Adaptability:</strong> Adjust plans when circumstances change</li>
                  </ul>
                </div>
                ...
                <div className="border-l-4 border-purple-500 pl-4">
                  ...
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li>• <strong>Performance Review:</strong> Analyze completion times and quality</li>
                    <li>• <strong>Process Optimization:</strong> Identify and eliminate bottlenecks</li>
                    <li>• <strong>Team Feedback:</strong> Gather input from activity participants</li>
                    <li>• <strong>Standardization:</strong> Create templates for recurring activities</li>
                    <li>• <strong>Training:</strong> Develop team skills and knowledge</li>
                  </ul>
                </div>
                ...
                <div className="mt-6 p-4 bg-rose-50 border border-rose-200 rounded-lg">
                  ...
                  <ul className="text-sm text-rose-700 space-y-1">
                    <li>• Use consistent naming conventions for better searchability</li>
                    <li>• Set up automated notifications for deadline reminders</li>
                    <li>• Regular review of completed activities for process improvement</li>
                    <li>• Leverage activity templates for common work types</li>
                    <li>• Maintain detailed notes for future reference and training</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          {selectedSubsection &&
           !["activity-overview", "activity-list", "activity-details", "filtering-sorting", "creating-activities", "managing-activities", "activity-types", "best-practices"].includes(selectedSubsection) && (
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Activity Management</h3>
              <p className="text-gray-600 mb-6">
                Select a specific topic from the left menu to learn more about Activity Management features.
              </p>
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="font-semibold text-blue-800 mb-2">Available Topics:</h4>
          ...
          {selectedSection === "activities" && !selectedSubsection && (
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Activity Management Overview</h3>
              <p className="text-gray-600 mb-6">
                Welcome to the Activity Management section. Select a specific topic from the left menu to learn more about managing manufacturing activities.
              </p>

              <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
                <h4 className="font-semibold text-amber-800 mb-2">Available Topics:</h4>
                <ul className="text-sm text-amber-700 space-y-1">
                  <li>• <strong>Getting Started:</strong> Introduction and key features</li>
                  <li>• <strong>Activity List View:</strong> Understanding the left panel</li>
                  <li>• <strong>Activity Details:</strong> Working with the right panel</li>
                  <li>• <strong>Filtering & Sorting:</strong> Finding and organizing activities</li>
                  <li>• <strong>Creating Activities:</strong> Building new activities</li>
                  <li>• <strong>Managing Activities:</strong> Updating and tracking</li>
                  <li>• <strong>Activity Types:</strong> Understanding categories</li>
                  <li>• <strong>Best Practices:</strong> Tips for success</li>
                </ul>
              </div>
            </div>
          )}
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="border-l-4 border-gray-400 pl-4">
                <h4 className="font-semibold text-gray-800 mb-3">Security Management</h4>
                <p className="text-sm text-gray-600 mb-3">
              ...
              <div className="border-l-4 border-gray-400 pl-4">
                <h4 className="font-semibold text-gray-800 mb-3">Performance Monitoring</h4>
                <p className="text-sm text-gray-600 mb-3">
                  Monitor system performance and optimize platform operations.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <h5 className="font-medium text-gray-800 mb-2">System Metrics</h5>
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <h5 className="font-medium text-gray-800 mb-2">Optimization</h5>
                    <ul className="text-xs text-gray-700 space-y-1">
            ...
            <div className="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="font-semibold text-gray-800">Administration Best Practices</h4>
              </div>
              ...
              {selectedSection && selectedSection !== "" ? (
                ...
                <div className="h-full flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                      Select a topic from the left menu to begin exploring comprehensive guides, tips, and best practices for mastering the Nexus LMD platform.
                    </p>
                  </div>
                </div>
              )}

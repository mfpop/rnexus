...
export const useHelpContext = () => {
  ...
  if (context === undefined) {
    ...
    if (import.meta.env.DEV) {
      console.error(
        "HelpContext Error: Component is not wrapped in HelpProvider",
      );
      console.error(
        "Make sure HelpLeftCard and HelpRightCard are wrapped in HelpProvider",
      );
      console.error("Check StableLayout.tsx around line 629");
    }
    throw new Error(
      "useHelpContext must be used within a HelpProvider. Make sure the component is wrapped in HelpProvider.",
    );
  }
  return context;
};

...
interface HomeLeftCardProps {}

/**
 * HomeLeftCard - Home page specific left card component
 * Based on LeftCardTemplate with Table of Contents from home.md
 * Contains navigation items with exact structure from home.md specification
 */
const HomeLeftCard: React.FC<HomeLeftCardProps> = () => {

...
const TeamsPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<"meetings" | "channels" | "chat">(
    "meetings",
  );
      ...
      try {
        ...
        if (isInitialized) {
          ...
          try {
            ...
            console.log("TeamsPage: Data loaded:", {
              meetingsData,
              channelsData,
              chatsData,
            });
        ...
        try {
          ...
          console.error(
            "TeamsPage: Failed to load fallback data:",
            fallbackError,
          );
          setError(
  ...
  const joinMeeting = async (meeting: TeamsMeeting) => {
    try {
      ...
      if (meeting.joinUrl) {
        ...
        if (success) {
          console.log(
            `TeamsPage: Successfully joined meeting: ${meeting.title}`,
          );
          // Show success message to user
          alert(`Joining meeting: ${meeting.title}`);
        } else {
          console.log(
            `TeamsPage: Teams service failed, using fallback for: ${meeting.title}`,
          );
        ...
        console.log(
          `TeamsPage: No join URL available for meeting: ${meeting.title}`,
        );
        // For meetings without URLs, show a message
        alert(
          `Meeting "${meeting.title}" doesn't have a join link. Please contact the meeting organizer.`,
        );
      }
    } catch (error) {
      ...
      if (meeting.joinUrl) {
        console.log(
          "TeamsPage: Using fallback URL opening for:",
          meeting.title,
        );
        window.open(meeting.joinUrl, "_blank");
      } else {
        alert(
          `Unable to join meeting "${meeting.title}". Please try again or contact support.`,
        );
      }
    }
  };
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Collaborate, communicate, and stay connected with your team
                </p>
              </div>
            </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700 mt-1">
                    You're viewing Teams data in demonstration mode. In a real
                    Microsoft Teams environment, this would connect to your
                    actual Teams account and show real meetings, channels, and
                    chats.
                  </p>
                </div>
              </div>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6">
                  Create your first team meeting to get started
                </p>
                <button
                  onClick={createMeeting}
                  className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200"
          ...
          <div className="space-y-6">
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6">
                  Join or create channels to start collaborating
                </p>
              </div>
            ) : (
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">

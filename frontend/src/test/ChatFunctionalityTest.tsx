          ...
          case 0: // Message Input
            try {
              ...
              return {
                ...
                message: input ? 'Message input found and accessible' : 'Message input not found'
              };
            } catch {
              return { ...test, status: 'fail', message: 'Error testing message input' };
            }

          case 1: // Voice Recording
            try {
              const micButton = document.querySelector('[title="Hold to record voice message"]');
              return {
                ...test,
                status: micButton ? 'pass' : 'fail',
                message: micButton ? 'Voice recording button found' : 'Voice recording button not found'
              };
            } catch {
              return { ...test, status: 'fail', message: 'Error testing voice recording' };
            }

          case 2: // File Upload
            try {
              const attachButton = document.querySelector('[title="Attach file or media"]');
              return {
                ...test,
                status: attachButton ? 'pass' : 'fail',
                message: attachButton ? 'File upload button found' : 'File upload button not found'
              };
            } catch {
              return { ...test, status: 'fail', message: 'Error testing file upload' };
            }
          ...
          case 3: // Emoji Picker
            try {
              ...
              return {
                ...
                message: emojiButton ? 'Emoji picker button found' : 'Emoji picker button not found'
              };
            } catch {
              return { ...test, status: 'fail', message: 'Error testing emoji picker' };
            }

          case 4: // Message Actions
            try {
              const selectionButton = document.querySelector('[title="Select messages"]');
              return {
                ...test,
                status: selectionButton ? 'pass' : 'fail',
                message: selectionButton ? 'Message selection button found' : 'Message selection button not found'
              };
            } catch {
              return { ...test, status: 'fail', message: 'Error testing message actions' };
            }
          ...
          case 5: // Chat Header Actions
            try {
              ...
              return {
                ...
                message: moreButton ? 'Chat header actions found' : 'Chat header actions not found'
              };
            } catch {
              return { ...test, status: 'fail', message: 'Error testing chat header actions' };
            }
          ...
          case 6: // Search Functionality
            try {
              ...
              return {
                ...
                message: searchButton || expandableSearch ? 'Search functionality found' : 'Search functionality not found'
              };
            } catch {
              return { ...test, status: 'fail', message: 'Error testing search functionality' };
            }
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Chat Functionality Test</h1>
        ...
        <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
          ...
          <div className="space-y-2 text-sm text-gray-700">
            <p><strong>1. Message Input:</strong> Type in the message box and press Enter</p>
            <p><strong>2. Emoji Button:</strong> Click the 😀 button to open emoji picker</p>
            <p><strong>3. Attachment Button:</strong> Click the 📎 button to open attachment menu</p>
            <p><strong>4. Voice Recording:</strong> Hold the 🎤 button to record voice</p>
            <p><strong>5. Header Actions:</strong> Click the ⋮ button for more options</p>
            <p><strong>6. Search:</strong> Click the 🔍 button to search messages</p>
            <p><strong>7. Selection Mode:</strong> Click the select button in header</p>
          </div>
        </div>
      </div>
    </div>
